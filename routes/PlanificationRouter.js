...
router.get('/:semestre/:section_id' , async (req , res) =>{
...
router.get('/:semestre/:section_id/:module_id' , async (req , res) => {
...
router.post('/:semestre/:section_id/:module_id' , async (req , res) =>{
...
router.get('/:semestre/:section_id/:module_id/update' , async (req , res) =>{
...
router.post('/:semestre/:section_id/:module_id/update' , async (req,res) => {
